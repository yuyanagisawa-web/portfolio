        ...
        <div className="max-w-5xl mx-auto py-20">
          ...
          <section className="mb-10">
            ...
            <p className="text-sm md:text-base text-gray-300 leading-7 md:leading-8">
              美容室の集客および採用応募の強化を目的として制作しました。 <br />
              <br />
              サロンの高級感や技術力が伝わることに加え、初めて訪れるユーザーにも親しみやすさを感じてもらえるよう、 <br />
              写真を活かしたデザインやレイアウトを意識しています。
            </p>
          </section>
          ...
          <section className="mb-10">
            ...
            <p className="text-sm md:text-base text-gray-300 leading-7 md:leading-8">
              ...
              閲覧時にサロンの雰囲気や魅力が伝わるよう工夫しました。 <br /> <br />

              また、写真が主役となるよう余白や文字サイズのバランスを調整し、視線の流れを意識しながらデザインを制作しています。 <br /> <br />

              高級感や洗練された印象を表現しつつも、採用や来店を検討しているユーザーが親しみやすさを感じられるデザインを目指しました。
            </p>
          </section>
