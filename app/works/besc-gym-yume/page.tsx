        ...
        <div className="max-w-5xl mx-auto py-20">
          ...
          <section className="mb-10">
            ...
            <p className="text-sm md:text-base text-gray-300 leading-7 md:leading-8">
              体操クラブの魅力や安心感が伝わるよう、<br />
              ファーストビューの見せ方や情報導線を意識して制作しました。<br /><br />

              初めてサイトを訪れる保護者や入会を検討しているユーザーにも内容が伝わりやすいよう、<br />
              写真を活かしたデザインと分かりやすい情報設計を心掛けています。
            </p>
          </section>
          ...
          <section className="mb-10">
            ...
            <p className="text-sm md:text-base text-gray-300 leading-7 md:leading-8">
              ファーストビューではローディングアニメーションを取り入れ、<br />
              体操クラブの楽しさや活気が伝わる第一印象を演出しました。<br />
              <br />
              また、KV直下にカテゴリを配置することで、<br />
              ユーザーが興味のある記事や情報へスムーズにアクセスできる導線を設計しています。<br />

              デザイン面では写真の魅力が伝わるよう余白やレイアウトのバランスを調整し、<br />
              スマートフォンでも読みやすいよう情報の優先順位や視認性を意識して制作しました。
            </p>
          </section>
