        ...
        <div className="max-w-5xl mx-auto py-20">
          ...
          <section className="mb-10">
            ...
            <p className="text-sm md:text-base text-gray-300 leading-7 md:leading-8">
              体操クラブの魅力や安心感が伝わるよう、コラムサイトのデザイン・コーディングを担当しました。<br /><br />

              初めてサイトを訪れる保護者や入会を検討しているユーザーにも内容が伝わりやすいよう、<br />
              写真を活かしたデザインと分かりやすいレイアウトを意識しています。
            </p>
          </section>
          ...
          <section className="mb-10">
            ...
            <p className="text-sm md:text-base text-gray-300 leading-7 md:leading-8">
              ファーストビューではローディングアニメーションを取り入れ、体操クラブの楽しさや活気が伝わる第一印象を演出しました。
              <br /><br />

              また、ファーストビュー直下にカテゴリを配置することで、ユーザーが興味のある記事へアクセスしやすい構成としています。
              <br /><br />

              デザイン面では写真が引き立つよう余白やレイアウトのバランスを調整し、<br />
              スマートフォンでも読みやすいよう文字サイズやコンテンツの配置を工夫しました。
            </p>
          </section>
