        ...
        <div className="max-w-5xl mx-auto py-20">
          ...
          <section className="mb-10">
            ...
            <p className="text-sm md:text-base text-gray-300 leading-7 md:leading-8">
              長野旅行の魅力やサービス内容が伝わるよう、観光サイトのデザイン・コーディングを担当しました。<br /><br />

              旅行を検討しているユーザーが実際の旅行イメージを持ちやすいよう、<br />
          ...
          <section className="mb-10">
            ...
            <p className="text-sm md:text-base text-gray-300 leading-7 md:leading-8">
              長野の自然や観光地の魅力が伝わるよう、写真を大きく配置し、視覚的に楽しめるデザインを目指しました。<br /><br />

              また、観光プランやサービス内容を比較しやすいよう情報を整理し、必要な情報へアクセスしやすいレイアウトを意識しています。<br /><br />

              デザイン面では余白や文字サイズのバランスを調整し、幅広い年代のユーザーにも読みやすい構成としました。<br /><br />

              さらに、スマートフォンでの閲覧も考慮し、視認性や操作性を意識して実装しています。
            </p>
          </section>
