  ...
  "
          ...
          <section className="mb-10">
            ...
            <p className="text-sm md:text-base text-gray-300 leading-7 md:leading-8">
              タスク管理ツールでは、追加・編集・完了といった基本操作を迷わず行えることが重要だと考え、 <br />
              タスク管理UIを自主制作しました。 <br /> <br />

              タスク数が増えた場合でも、優先度や状態がひと目で把握できることを意識し、シンプルで整理されたUIを目指しています。
            </p>
          </section>
          ...
          <section className="mb-10">
            ...
            <p className="text-sm md:text-base text-gray-300 leading-7 md:leading-8">
              タスクの追加・編集・完了切り替えといった操作が直感的に行えるよう、 <br />
              画面内の情報量を絞り、必要な機能をひとつの画面にまとめました。 <br /> <br />

              また、優先度や完了状態が視覚的に分かるよう、表示の切り替えや情報の配置を調整し、 <br />
              タスクの状況を把握しやすいUIにしています。 <br /> <br />

              カードUIでは余白や文字サイズのバランスを調整し、情報が増えても見やすさを保てるよう工夫しました。 <br /> <br />

              レスポンシブ対応では、スマートフォンでも操作しやすいようレイアウトやボタンサイズを見直し、 <br />
              快適に利用できることを意識して実装しています。
            </p>
          </section>
