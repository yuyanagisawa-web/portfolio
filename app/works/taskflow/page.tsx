  ...
  "
          ...
          <section className="mb-10">
            ...
            <p className="text-sm md:text-base text-gray-300 leading-7 md:leading-8">
              ...
              タスクの追加・編集・完了切り替えをひとつの画面内で完結できるようにし、<br />
              操作の流れが分かりやすいUIを意識しました。<br /><br />

              新規タスクはすぐ追加できるよう入力欄をシンプルにまとめ、編集機能も持たせることで、<br />
              入力ミスや内容変更にも対応できるようにしています。
              <br /><br />
              また、優先度や完了状態がひと目で分かるよう表示の違いをつけ、<br />
              情報量が増えても見やすさを保てるようカードUIの余白やレイアウトを調整しました。<br /><br />

              スマートフォンでも操作しやすいよう、ボタンサイズや余白、<br />
              レイアウトの切り替えも意識して実装しています。
            </p>
          </section>
