  ...
  "
                    ...
                    <section id="concept" className="mb-10">
                        ...
                        <p className="text-sm md:text-base text-[#6f6258] leading-8 max-w-3xl">
                            自然由来のスキンケアアイテムを展開するコスメブランドを想定し、ECサイトを自主制作しました。<br />
                            <br />
                            商品の魅力だけでなく、ユーザーが商品を比較しながら迷わず購入まで進めることを意識し、<br />ブランドの世界観と使いやすさの両立を目指しています。                        </p>
                    </section>

                    <section className="mb-10">
                        <h2 className="text-2xl md:text-3xl font-bold mb-4">工夫した点</h2>
                        <p className="text-sm md:text-base text-[#6f6258] leading-8 max-w-3xl">
                            スキンケアブランドらしい上品で落ち着いた印象を表現するため、色数を抑え、<br />
                            余白や角丸を活かしたデザインにしました。<br />
                            <br />
                            また、商品一覧では画像・商品名・説明・価格・購入ボタンへと自然に視線が流れるよう情報を整理し、<br />
                            商品詳細ページでは特徴や価格、購入CTAが分かりやすく伝わる構成を意識しています。<br />
                            <br />
                            スマートフォンでも快適に閲覧できるよう、視認性や操作性にも配慮しながら実装を行いました。
                        </p>
                    </section>
                    <section className="mb-10">
                        ...
                        <p className="text-sm md:text-base text-[#6f6258] leading-8 max-w-3xl">
                            ECサイトでは見た目の美しさだけでなく、ユーザーが迷わず商品を選び、<br />
                            購入まで進めるための導線設計が重要であることを意識しながら制作しました。<br /><br />

                            制作を通して、ブランドイメージとユーザビリティの両立について理解を深めることができました
                        </p>
                    </section>
                </div>
            </main>
